...
class BMIS_Metrics_Calculator(object):
    ...
    def get_metrics(self, metric, y_pred, y_true):
        ...
        elif metric == 'mIoU': return self.calculate_mIoU(y_pred, y_true)
    ...
    def calculate_mIoU(self, y_pred, y_true):
        y_pred_f = y_pred > 0.5
        y_true_f = y_true > 0.5
