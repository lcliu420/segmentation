...
export async function slide02(presentation, ctx) {
  ...
  callout(slide, ctx, 760, 318, 330, 124, "当前尝试",
    ...
    C.green, C.greenSoft);
  text(slide, ctx, 82, 548, 850, 44, "讲解时可以强调：这一步是“轻量插入模块”，不是重新设计整套网络。", {
    size: 21, color: C.orange, bold: true,
  });
  return slide;
}
