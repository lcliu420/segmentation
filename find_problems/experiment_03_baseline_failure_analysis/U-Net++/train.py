...
UNETPP_ROOT = Path(__file__).resolve().parent
EXPERIMENT_ROOT = UNETPP_ROOT.parent
REPO_ROOT = EXPERIMENT_ROOT.parent


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train U-Net++ for WL/NBI gastric segmentation.")
...
def main() -> None:
    ...
    model = UNetPlusPlus(in_channels=3, num_classes=args.num_classes).to(device)
